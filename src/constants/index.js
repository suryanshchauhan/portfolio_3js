...
const testimonials = [
  ...
  },
  {
    ...
    company: "Amazon",
    image:
      "https://media.licdn.com/dms/image/D4D35AQF2b8AywmJQgw/profile-framedphoto-shrink_800_800/0/1635598643815?e=1678766400&v=beta&t=PLo661wWrbF4VY5KcDe1tNNneOYTPtoIIjGxCOuA6_0",
  },
  {
    testimonial:
...
const projects = [
  ...
  },
  {
    ...
    description:
      "Full-Stack Web application that keeps a track of a fact you learned (along with source), has different categories and the option to upvote/downvote.",
    tags: [
      {
        name: "fullstack",
  ...
  },
  {
    name: "Covid Stats",
    description:
      "R webapp that lets you choose a date range and chose the COVID statistic you want to see on an interactive world map. ",
    tags: [
      {
        name: "R",
        color: "blue-text-gradient",
